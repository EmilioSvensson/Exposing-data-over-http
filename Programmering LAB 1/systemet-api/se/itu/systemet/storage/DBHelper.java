...
public class DBHelper {
  ...
  //SELECT product.name, product.nr, product.alcohol, product.price, product.volume, product.type, productGroup.name AS 'Product Group' FROM product JOIN productGroup ON product.productGroupId = productGroup.id;
  ...
  public static ResultSet productsResultSet() {
    try {
      ...
      StringBuilder SQL = new StringBuilder("SELECT ")
        ...
        .append(" AS ").append(" 'Prodcut Group' ")
